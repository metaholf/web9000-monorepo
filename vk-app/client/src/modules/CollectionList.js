...
const buttonGridStyle = { width: '100%', height: '100%', border: '1px solid purple', background: 'transparent', color: 'blue', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '20px', padding: '20px' }
